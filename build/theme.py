...
/* --- Founder story (Mario) --------------------------------------------- */
.fstory{display:grid;grid-template-columns:300px 1fr;gap:clamp(28px,4vw,56px);align-items:center;
...
.fstory__media{text-align:center}
.fstory__media img{width:100%;max-width:300px;height:auto;margin:0 auto;display:block;
  border-radius:var(--radius);background:linear-gradient(160deg,rgba(14,77,100,.10),rgba(245,166,35,.14))}
.fstory__badge{display:inline-flex;gap:8px;align-items:center;margin-top:14px;background:var(--bg);
  border:1px solid var(--line);border-radius:999px;padding:8px 14px;font-weight:600;font-size:.9rem;color:var(--petrol)}
.fstory p{color:var(--ink)}
.fstory blockquote{margin:18px 0 10px;padding:18px 22px;background:var(--bg);border-radius:var(--radius);
  font-family:var(--font-head);font-weight:700;font-size:1.15rem;line-height:1.45;color:var(--petrol)}
.fstory cite{font-style:normal;font-family:var(--font-head);font-weight:700;color:var(--petrol)}
.fstory cite small{display:block;font-family:var(--font-body);font-weight:600;color:var(--muted)}
@media(max-width:820px){.fstory{grid-template-columns:1fr}.fstory__media img{max-width:220px}}
