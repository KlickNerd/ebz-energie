...
.prose-panel--dark p{color:#c6dbe2}
.prose-panel .ic{width:54px;height:54px;border-radius:15px;background:rgba(245,166,35,.14);
  color:var(--amber-2);display:grid;place-items:center;font-size:1.5rem;margin-bottom:16px}
.prose-panel--dark .ic{background:rgba(245,166,35,.2);color:var(--amber)}
